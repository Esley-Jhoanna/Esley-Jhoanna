...
<div style="width: 800px; height: 400px; background-image: url('https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExMnYzdmY2bHpucHo2aXhiMDVwNmNieTVsdTh2cWc0YjdmYzVlYWxkeSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/g06HKnMmtK1aXurndU/giphy.gif'); background-size: 800px 500px; background-position: top center; background-repeat: no-repeat;">
    hey
</div>
...
### 🧠Expertises:<br/>
✅Front-End<br/>
HTML/CSS/SCSS/JS/TS, Tailwind CSS/Bootstrap, Angular, React.js/Nextjs, Vue/Nuxtjs, etc<br/>
✅Back-End<br/>
PHP(Laravel, Custom Frameworks), Python(Django, Falsk),Golang(Fiber), C#(ASP.Net), Node.js(Express.js, Nest.js), Java(Spring Boot, Spring MVC), Ruby on Rails, etc.<br/>
✅Database<br/>
SQL, MySQL, PostgreSQL, NoSQL, MongoDB, etc<br/>
✅Design & Prototyping<br/>
Figma, Adobe XD, etc<br/>
✅DevOps<br/>
AWS, Linux, Digital Ocean, Google Cloud, Azure, Windows Server, VPS, etc<br/>
✅API Development<br/>
RESTful, GraphQL<br/>
✅Testing<br/>
InfluxDB, Grafana, K6, Cypress.js, Jest.js, and PHPUnit, etc<br/>
✅No-Code<br/>
Bubble.io, Wordpress, Wix, Webflow, SquareSpace, PrestaShop, Xano<br/>
✅Mobile App Development<br/>
React Native, Flutter<br/>
✅API Integration<br/>
Google Cloud, Klarna, Stripe, etc<br/>
✅AI & ML Integration<br/>
My proficiency extends to AI and machine learning technologies, with hands-on experience in Python (LangChain, GPT-3, GPT-4) and the development of AI-driven applications ranging from chatbots to content creation tools.<br/>
✅Shopify<br/>
